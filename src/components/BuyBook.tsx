        ...
        <div className={styles.card}>
          <div className={styles.content}>
            ...
            <div className={styles.actions}>
              <a 
                href="https://www.amazon.in/Numbers-Magic-Numerology-Shalu-Singh/dp/B0D4R3FRYX?dplnkId=59fc02ab-d3a5-4993-9b71-45268c60b71e" 
                target="_blank" 
              ...
              <span className={styles.deliveryInfo}>*Secure transaction via Amazon.in</span>
            </div>
          </div>
